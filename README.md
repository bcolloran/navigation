...
In this project, an agent is trained to collect bananas in a large, square world.
...
To train an agent, you may simply open the Jupyter notebook `Navigation.ipynb` and evaluate all the cells in order -- the notebook contains all the code necessary to define and train the agent.
